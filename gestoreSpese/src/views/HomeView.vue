<template>
  <section class="bg-[#374151]">
    <div
      class="py-20 px-4 w-xl flex flex-col justify-center items-center text-center lg:py-16 h-screen"
    >
      <h1
        class="text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl"
      >
