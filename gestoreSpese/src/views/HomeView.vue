<template>
  <section class="bg-[#374151]">
    <div class="px-4 mx-auto w-xl text-center lg:py-16 z-10 relative">
      ...
      <p
        class="text-lg font-normal text-white lg:text-xl sm:px-16 lg:px-48"
      >
    ...
    <div
      class="bg-gradient-to-b from-blue-50 to-transparent dark:from-blue-900 w-full absolute top-0 left-0 z-0"
    ></div>
  </section>
</template>
