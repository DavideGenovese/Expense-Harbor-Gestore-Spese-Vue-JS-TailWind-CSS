  ...
  <footer class="bg-[#111827]" aria-labelledby="footer-heading">
      ...
      <div class="px-5 py-12 mx-auto max-w-7xl lg:py-16 md:px-12 lg:px-20">
        <div class="md:grid md:grid-cols-5 md:gap-8">
          <div class="flex items-center">
            ...
            <span
              class="m-2 self-center text-xl font-semibold whitespace-nowrap text-white"
              >GestioneSpesa</span
            >
          </div>
              ...
              <ul role="list" class="mt-4 space-y-4">
                <li>
                  <a
                    ...
                    class="text-sm font-semibold text-white [&>svg]:h-14 [&>svg]:w-10"
                    ><svg
              ...
              <ul role="list" class="mt-4 space-y-4">
                <li>
                  <a
                    ...
                    class="text-sm font-normal text-white [&>svg]:h-6 [&>svg]:w-4"
                    ><svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 448 512"
    ...
    <div class="flex justify-between items-center mx-[150px]">
      <div class="mt-8 md:mt-0 w-full">
        <div
          class="mt-8 ml-6 flex justify-start items-center md:mt-0 md:order-1"
        >
          <span
      ...
      <div
        class="flex justify-center items-center px-5 py-12 mx-auto bg-[#111827] max-w-7xl sm:px-6 md:flex md:items-center md:justify-between lg:px-20"
      >
        <div
          class="flex justify-center items-center space-x-6 md:order-last md:mb-0"
        >
